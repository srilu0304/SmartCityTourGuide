...
public class SmartCityTourGuide {
    ...
    public void  showAttractions(String cityName) throws Exception {
        ...
        PreparedStatement statement = con.prepareStatement("SELECT Attractions FROM smartcity WHERE Cityname= ?");
    ...
    public void showRestaurants(String cityName) throws Exception {
    	Class.forName("oracle.jdbc.driver.OracleDriver");
		   Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","tiger");
        PreparedStatement statement = con.prepareStatement("SELECT Restaurants FROM smartcity WHERE Cityname = ?");
        statement.setString(1, cityName);
    ...
    public void showMalls(String cityName) throws Exception {
    	Class.forName("oracle.jdbc.driver.OracleDriver");
		   Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","tiger");
        PreparedStatement statement = con.prepareStatement("SELECT Malls FROM smartcity WHERE Cityname = ?");
        statement.setString(1, cityName);
